...
export function ChatInterface({
  ...
  return (
    <motion.div
      ...
      className="min-h-[calc(100vh-5rem)] md:min-h-[calc(100vh-6rem)] max-h-[calc(100vh-5rem)] md:max-h-[calc(100vh-6rem)] flex flex-col relative rounded-xl overflow-hidden shadow-lg border border-gray-100"
      dir="rtl">
      <ChatHeader
